  ...
  readValue() {
    ...
    switch (val) {
      ...
      case 0x3:
        return false;
      case 0x10:
        return this._buf.read(1, "int8");
      case 0x11:
        return this._buf.read(1, "uint8");
      case 0x12:
        return this._buf.read(2, "int16");
      case 0x13:
        return this._buf.read(2, "uint16");
      case 0x14:
        return this._buf.read(4, "int32");
      case 0x15:
        return this._buf.read(4, "uint32");
      case 0x16:
        return this._buf.read(8, "int64");
      case 0x17:
        return this._buf.read(8, "uint64");
      case 0x20:
        return this._buf.read(4, "float");
      case 0x21:
        return this._buf.read(8, "double");
      case 0x30:
        return this._buf.readString(this._buf.read(1, "uint8"));
      case 0x31:
        return this._buf.readString(this._buf.read(2, "uint16"));
      case 0x32:
        return this._buf.readString(this._buf.read(4, "uint32"));
      case 0x33:
        return this._buf.read(this._buf.read(1, "uint8") as number, "binary");
      case 0x34:
        return this._buf.read(this._buf.read(2, "uint16") as number, "binary");
      case 0x35:
        return this._buf.read(this._buf.read(4, "uint32") as number, "binary");
      case 0x36:
        return this._buf.read(8, "uint64");
      case 0x40:
        return new Date((this._buf.read(4, "uint32") as number) * 1000);
      case 0x50:
        return this.readArray(this._buf.read(1, "uint8"));
      case 0x51:
        return this.readArray(this._buf.read(2, "uint16"));
      case 0x52:
        return this.readArray(this._buf.read(4, "uint32"));
      case 0x53:
        return this.readArray(this._buf.read(8, "uint64"));
      case 0x60:
        return this.readMap(this._buf.read(1, "uint8"));
      case 0x61:
        return this.readMap(this._buf.read(2, "uint16"));
      case 0x62:
        return this.readMap(this._buf.read(4, "uint32"));
      case 0x63:
        return this.readMap(this._buf.read(8, "uint64"));
      //case 0x67: return this.readCompressedObject();
      case 0x68:
        return this.readLocalization();
      case 0x69:
        return this.readCalendar();
      case 0x70:
        return this.readFileRef();
      case 0x71:
        return this.readStoreEnabled();
      default: {
        console.log(
          "HEX:",
          val.toString(16),
...
encoder.encodeValue(json);
const buffer = encoder.returnValue();
fs.writeFileSync("test1.bin", buffer)
